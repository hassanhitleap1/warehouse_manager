            ...
            <table class="table table-striped">
                ...
                <?php foreach($outlays_day_model as $key_day => $outlay_day_model):?>
                    <tr>
                        ...
                        <th><?= $outlay_day_model["month"]?>/<?= $outlay_day_model["day"]?></th>
                    </tr>
                    <?php
                    $label_outlays_day_model[]=$outlay_day_model["profit_margin"];
                    $data_outlays_day_model[]=$outlay_day_model["month"] ."/". $outlay_day_model["day"];?>
                <?php endforeach;?>
        ...
        <div class="col-md-6">
            <table class="table table-striped">
                ...
                <?php foreach($outlays_month_model as $key_month => $outlay_month_model):?>
                    ...
                    $data_profits_month_model[]=$outlay_month_model["outlays"];
                    ?>
                <?php endforeach;?>
...
<script>
    ...
    var label_profits_day_model = <?=json_encode($label_outlays_day_model)?>;
    var  data = {
    ...
    var label_profits_month_model = <?=json_encode($label_outlays_month_model)?>;
