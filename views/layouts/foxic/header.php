        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-auto hdr-logo">
                    <a href="index.html" class="logo"><img srcset="images/logo.webp 1x, images/logo2x.webp 2x" alt="Logo"></a>
                </div>
                        ...
                        <div class="hdr-inline-link">
                            <div class="dropdn_language">
                                <div class="dropdn dropdn_language dropdn_language--noimg dropdn_caret">
                                    ...
                                    <div class="dropdn-content">
                                        <ul>
                                            <li class="active"><a href="#"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/flags/en.html" alt="">English</a></li>
                                            <li><a href="#"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/flags/sp.html" alt="">Spanish</a></li>
                                            <li><a href="#"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/flags/de.html" alt="">German</a></li>
                                            <li><a href="#"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/flags/fr.html" alt="">French</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <li class="mmenu-item--simple"><a href="#" class="active">Home</a>
                                <div class="mmenu-submenu d-flex">
                                    <ul class="submenu-list mt-0">
                                        <li><a href="index.html">Fashion (Default) Skin</a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen01.html" alt=""></span></li>
                                        <li><a href="index-sport.html">Sport Skin</a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen-sport.html" alt=""></span></li>
                                        <li><a href="index-books.html">Books Skin <span class="menu-label  menu-label--color3">NEW</span></a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen-books.html" alt=""></span></li>
                                        <li><a href="index-electronics.html">Electronics Skin <span class="menu-label  menu-label--color3">NEW</span></a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen-electronics.html" alt=""></span></li>
                                        <li><a href="index-viping.html">Vaping Skin <span class="menu-label  menu-label--color3">NEW</span></a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen-vaping.html" alt=""></span></li>
                                        <li><a href="index-pets.html">Pets Skin</a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen-pets.html" alt=""></span></li>
                                        <li><a href="index-lingeries.html">Lingeries Skin</a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen-lingeries.html" alt=""></span></li>
                                        <li><a href="index-games.html">Games Skin</a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen-games.html" alt=""></span></li>
                                        <li><a href="index-helloween.html">Halloween Skin</a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen-halloween.html" alt=""></span></li>
                                        <li><a href="index-medical.html">Medical Skin</a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen-medical.html" alt=""></span></li>
                                        <li><a href="index-food.html">Food Market Skin</a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen-food.html" alt=""></span></li>
                                        <li><a href="index-cosmetics.html">Cosmetics Skin</a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen-cosmetics.html" alt=""></span></li>
                                        <li><a href="index-fishing.html">Fishing Skin</a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen-fishing.html" alt=""></span></li>
                                    </ul>
                                    <ul class="submenu-list mt-0">
                                        <li><a href="#">Cups&Mugs Skin <span class="menu-label menu-label--color1">Coming Soon</span></a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen-cups.html" alt=""></span></li>
                                        <li><a href="#">Bikes Skin <span class="menu-label menu-label--color2">Coming Soon</span></a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen-bikes.html" alt=""></span></li>
                                        <li><a href="#">T-Shirts Skin <span class="menu-label">Coming Soon</span></a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen-tshirts.html" alt=""></span></li>
                                        <li><a href="index-02.html">Home page 2</a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen02.html" alt=""></span></li>
                                        <li><a href="index-03.html">Home page 3</a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen03.html" alt=""></span></li>
                                        <li><a href="index-04.html">Home page 4</a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen04.html" alt=""></span></li>
                                        <li><a href="index-05.html">Home page 5</a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen05.html" alt=""></span></li>
                                        <li><a href="index-06.html">Home page 6</a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen06.html" alt=""></span></li>
                                        <li><a href="index-07.html">Home page 7</a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen07.html" alt=""></span></li>
                                        <li><a href="index-08.html">Home page 8</a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen08.html" alt=""></span></li>
                                        <li><a href="index-09.html">Home page 9</a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen09.html" alt=""></span></li>
                                        <li><a href="index-10.html">Home page 10</a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen10.html" alt=""></span></li>
                                        <li><a href="index-rtl.html">Home page RTL</a><span class="submenu-link-image"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/screen/screen-rtl.html" alt=""></span></li>
                                    </ul>
                                </div>
                            </li>
                                        ...
                                        <div class="container">
                                            <div class="mmenu-left width-25">
                                                <div class="mmenu-bnr-wrap">
                                                    <a href="#" class="image-hover-scale"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-srcset="images/menu/mmenu-bnr-01.webp" class="lazyload fade-up" alt=""></a>
                                                </div>
                                    ...
                                    <div class="mmenu-submenu-inside">
                                        <div class="container">
                                            <div class="mmenu-right width-25">
                                                <div class="mmenu-bnr-wrap">
                                                    <a href="#" class="image-hover-scale"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-srcset="images/menu/mmenu-bnr-02.webp" class="lazyload fade-up" alt=""></a>
                                                </div>
                                                <h3 class="submenu-title"><a href="category.html">Pre-Collection<br>Spring-Summer 2021</a></h3>
                                            </div>
                                            <div class="mmenu-cols column-4">
                    ...
                    <div class="mobilemenu-language">
                        <div class="dropdn_language">
                            <div class="dropdn dropdn_language dropdn_language--noimg dropdn_caret">
                                ...
                                <div class="dropdn-content">
                                    <ul>
                                        <li class="active"><a href="#"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/foxic/images/flags/en.html" alt="">English</a></li>
                                        <li><a href="#"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/foxic/images/flags/sp.html" alt="">Spanish</a></li>
                                        <li><a href="#"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/foxic/images/flags/de.html" alt="">German</a></li>
                                        <li><a href="#"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/foxic/images/flags/fr.html" alt="">French</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="minicart-drop-content js-dropdn-content-scroll">
                <div class="minicart-prd row">
                    <div class="minicart-prd-image image-hover-scale-circle col">
                        <a href="product.html"><img class="lazyload fade-up" src="<?php echo  Yii::$app->request->baseUrl;?>/theme/foxic/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?php echo  Yii::$app->request->baseUrl;?>/theme/foxic/images/skins/fashion/products/product-01-1.webp" alt=""></a>
                    </div>
                ...
                <div class="minicart-prd row">
                    <div class="minicart-prd-image image-hover-scale-circle col">
                        <a href="product.html"><img class="lazyload fade-up" src="<?php echo  Yii::$app->request->baseUrl;?>/theme/foxic/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?php echo  Yii::$app->request->baseUrl;?>/theme/foxic/images/skins/fashion/products/product-16-1.webp" alt=""></a>
                    </div>
                    <div class="minicart-prd-info col">
                        <div class="minicart-prd-tag">FOXic</div>
