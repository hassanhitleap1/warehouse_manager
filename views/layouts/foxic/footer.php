                ...
                <div class="col-lg last-mobile">
                    <div class="footer-block">
                        <div class="footer-logo">
                            <a href="index.html"><img class="lazyload fade-up" src="<?php echo  Yii::$app->request->baseUrl;?>/theme/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-srcset="images/logo-footer.webp 1x, images/logo-footer2x.webp 2x" alt="Logo"></a>
                        </div>
                        <ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-auto sticky-addcart_image">
                    <a href="product.html">
                        <img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/skins/fashion/products/product-01-1.html" alt=""/>
                    </a>
                </div>
                ...
                <div class="col-auto sticky-addcart_actions">
                    ...
                    <div class="btn-wrap">
                        <button class="btn js-prd-addtocart" data-fancybox data-src="<?php echo  Yii::$app->request->baseUrl;?>/theme/#modalCheckOut">Add to cart
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-auto popup-addedtocart_logo">
                    <img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/logo-white-sm.webp" class="lazyload fade-up" alt="">
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-auto sticky-addcart_image sticky-addcart_image--zoom">
                    <a href="#" data-caption="">
                        <span class="image-container"><img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/#" alt=""/></span>
                    </a>
                </div>
                <div class="col col-sm-5 col-lg-4 col-xl-5 sticky-addcart_info">
            ...
            <div class="payment-notification-inside">
                <div class="payment-notification-container">
                    <a href="#" class="payment-notification-image js-pn-link">
                        <img src="<?php echo  Yii::$app->request->baseUrl;?>/theme/images/products/product-01.html" class="js-pn-image" alt="">
                    </a>
                ...
                <div class="payment-notification-qw prd-hide-mobile js-prd-quickview" data-src="<?php echo  Yii::$app->request->baseUrl;?>/theme/ajax/ajax-quickview.html"><i class="icon-eye"></i></div>
            </div>
        </div>
    </div>
</div>