            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview menu-open">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('dashboard/index')?>" class="nav-link
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('dashboard/sales')?>" class="nav-link
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('dashboard/outlay')?>" class="nav-link
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('dashboard/best-seller')?>" class="nav-link
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('dashboard/orders')?>" class="nav-link
                ...
                <li class="nav-item has-treeview menu-open">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('orders/index')?>" class="nav-link
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('orders/create')?>" class="nav-link
                ...
                <li class="nav-item has-treeview menu-open">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('products/index')?>" class="nav-link
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('sub-product-count/index')?>" class="nav-link
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('options-sell-product/index')?>" class="nav-link
                ...
                <li class="nav-item has-treeview menu-open">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('suppliers/index')?>" class="nav-link
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('users/index')?>" class="nav-link
                ...
                <li class="nav-item has-treeview menu-open">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('countries/index')?>" class="nav-link
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('regions/index')?>" class="nav-link
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('area/index')?>" class="nav-link
                ...
                <li class="nav-item has-treeview menu-open">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('categorises/index')?>" class="nav-link
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('units/index')?>" class="nav-link
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('status/index')?>" class="nav-link
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('warehouse/index')?>" class="nav-link
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('company-delivery/index')?>" class="nav-link
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('price-company-delivery/index')?>" class="nav-link
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('change-password/index')?>" class="nav-link
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('outlays/index')?>" class="nav-link
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::toRoute('type-outlay/index')?>" class="nav-link
                ...
                <li class="nav-item">
                    <a href="<?= Url::toRoute('settings/index')?>"  class="nav-link <?= Yii::$app->controller->route =='settingss/index'?'active':''?>">
